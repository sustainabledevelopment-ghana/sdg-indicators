...
If you have feedback on the data sources we have used or have suggestions for new data sources then please email us at <a href="mailto:{{site.email_contacts.questions}}">sdg.secretariat@statsghana.gov.gh{{site.email_contacts.suggestions}}</a>.
